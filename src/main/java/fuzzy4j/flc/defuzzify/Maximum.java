 ...
 *
 * <ul>
 *   <li>{@link Maximum#minOfMax()} Considers the first maximum, for T this is b</li>
 *   <li>{@link Maximum#maxOfMax()} Considers the last maximum, for T this is c</li>
 *   <li>{@link Maximum#meanOfMax()} Considers the mean of first and last maximum, for T this is (c - b) / 2</li>
 * </ul>
 *
