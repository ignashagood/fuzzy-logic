...
public class HierarchicalClustering<V> {
    ...
    public HierarchicalClustering(SimilarityMeasure<V> similarityHelper, Set<V> data) {
        this(data.size(), similarityHelper, data);
    }

    public HierarchicalClustering(double maximumDistance, SimilarityMeasure<V> similarityHelper, Set<V> data) {
    ...
    public static <V> double singleLinkageDistance(SimilarityMeasure<V> measure, Set<V> A, Set<V> B) {
